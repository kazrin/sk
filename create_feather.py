...
def create_feather_file(input_dir_path, output_file_path):
    ...
    df = df_agg.merge(
        aggregated_remarks[["医療機関番号", "受理番号", "備考集約"]], on=["医療機関番号", "受理番号"], how="left"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input-dir-path", type=str, help="input directory path that xlsx files are located. e.g. data/2025/10"
    )
